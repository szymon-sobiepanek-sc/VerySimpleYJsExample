var crdt = (function (exports) {
  ...
  const writeUint8Array = (encoder, uint8Array) => {
    ...
    if (rightCopyLen > 0) {
      ...
      encoder.cbuf = new Uint8Array(max(bufferLen * 2, rightCopyLen)); // copy array
  ...
  const readClientsStructRefs = (decoder, doc) => {
    ...
    for (let i = 0; i < numOfStateUpdates; i++) {
      ...
      let clock = readVarUint(decoder.restDecoder); // const start = performance.now()
          ...
          default:
            {
               ...
               * a few comments
               */
              const cantCopyParentInfo = (info & (BIT7 | BIT8)) === 0; // If parent = null and neither left nor right are defined, then we know that `parent` is child of `y`
  ...
  class LocalStoragePolyfill {
    ...
    constructor(room) {
      ...
      this.onmessage = null;
      onChange(e => e.key === room && this.onmessage !== null && this.onmessage({
    ...
    (function (e) {
      ...
      return function () {
        function d(s, e, n) {
          ...
          for (var r = "function" == typeof commonjsRequire && commonjsRequire, a = 0; a < n.length; a++) t(n[a]);
          ...
          (function () {
            (function () {
              ...
              function U(e, t, n, r, a) {
                return t = +t, n >>>= 0, a || B(e, t, n, 4), J.write(e, t, n, r, 23, 4), n + 4;
              }

              function j(e, t, n, r, a) {
                return t = +t, n >>>= 0, a || B(e, t, n, 8), J.write(e, t, n, r, 52, 8), n + 8;
              }
  ...
  class Room {
    ...
    connect() {
      ...
      broadcastBcMessage(this, toUint8Array(encoderSync)); // broadcast local state

      const encoderState = createEncoder();
      writeVarUint(encoderState, messageSync);
      writeSyncStep2(encoderState, this.doc);
      broadcastBcMessage(this, toUint8Array(encoderState)); // write queryAwareness

      const encoderAwarenessQuery = createEncoder();
      writeVarUint(encoderAwarenessQuery, messageQueryAwareness);
      broadcastBcMessage(this, toUint8Array(encoderAwarenessQuery)); // broadcast local awareness state
    ...
    disconnect() {
      ...
      removeAwarenessStates(this.awareness, [this.doc.clientID], 'disconnect'); // broadcast peerId removal via broadcastchannel
  ...
  var bundle = function bundle() {
    ...
    var ydoc = new Doc();
    new WebrtcProvider("something-here", ydoc, {
